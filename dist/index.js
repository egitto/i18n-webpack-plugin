...
var I18nPlugin = function () {
  function I18nPlugin(localization, options, failOnMissing) {
    ...
    this.missingLocalizationCallback = this.options.missingLocalizationCallback || function () {
      return 0;
    };
  }
  ...
  _createClass(I18nPlugin, [{
    ...
    value: function apply(compiler) {
      var localization = this.localization,
          ...
          missingLocalizationCallback = this.missingLocalizationCallback; // eslint-disable-line no-unused-vars
